...
const capabilities = [
    { title: "Flutter (Cross-Platform)", desc: "Building beautiful, performant apps for Android and iOS from a single codebase using Flutter and Dart.", icon: "🐦" },
    { title: "React Native", desc: "Cross-platform apps using JavaScript and React Native — sharing code between web and mobile.", icon: "⚛️" },
    { title: "Android (Java)", desc: "Native Android development with Java, Android SDK, Activity lifecycle, and Material Design components.", icon: "🤖" },
    { title: "Backend Integration", desc: "Connecting mobile apps to REST APIs, handling JWT authentication, and managing remote and local data sync.", icon: "🔗" },
    { title: "State Management", desc: "Managing app state with Provider, Riverpod (Flutter) or Redux, Zustand (React Native).", icon: "🗂️" },
    { title: "Local Storage & Offline", desc: "Implementing offline-first patterns with SQLite, Hive, or AsyncStorage for reliable user experience.", icon: "💾" },
];

const projects = [
    { title: "College Management App", desc: "Android app for managing student records, course enrollments, and academic data. Built in Java.", stack: ["Java", "Android SDK"], link: "https://github.com/Ramachandra-2096/SMVITM" },
];
            ...
            <div className="container mx-auto">
                ...
                <div className="mb-16">
                    ...
                    <p className="max-w-[640px] text-white/60 text-lg leading-relaxed">
                        Cross-platform and native mobile applications with Flutter, React Native, and Java.
                        Clean UI, reliable data handling, and smooth user experience across Android and iOS.
                    </p>
                </div>
