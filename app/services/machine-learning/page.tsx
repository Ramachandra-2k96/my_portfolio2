...
const capabilities = [
    { title: "Computer Vision", desc: "CNN-based classification, object detection, and segmentation. Trained models for plant disease detection, phishing site analysis, and aerial imaging." },
    { title: "NLP & LLMs", desc: "Fine-tuning language models, building RAG pipelines with LangChain and LlamaIndex, and chaining LLM calls for structured reasoning." },
    { title: "Autonomous Agents", desc: "Multi-step agent workflows using LangGraph. Agents with tool use, memory, and planning capabilities for complex real-world tasks." },
    { title: "Reinforcement Learning", desc: "Q-learning agents for sequential decision-making. Applied to autonomous drone navigation and game-playing agents." },
    { title: "Data Pipelines", desc: "End-to-end pipelines from raw ingestion through preprocessing, feature engineering, model training, and serving." },
    { title: "Model Serving", desc: "Wrapping trained models in FastAPI or Django endpoints, with input validation, versioning, and response formatting." },
];
